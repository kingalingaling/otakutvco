  ...
  return (
    <div className="w-full max-h-[350px] md:max-h-[300px] relative group">
      ...
      <div className="absolute pt-4 bg-black/70 w-full h-full z-30 font-bold text-white/80 flex justify-between items-center">
        <div className="mx-auto px-4 md:w-[85%] h-full flex flex-col md:flex-row justify-between items-center">
          <p className="text-center text-xs md:text-xl md:py-3 md:max-w-[50%] font-medium transition-opacity duration-500 opacity-100 group-hover:opacity-0">
          ...
          <LiaTelegram size={60} className="text-white opacity-100 group-hover:opacity-0 transition-opacity duration-500" />
