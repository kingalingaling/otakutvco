...
const Expectations = () => {
  return (
    <div className="w-full bg-white lg:bg-expect-lg lg:h-[90vh] bg-cover">
      <div className="p-4 w-full text-xs md:text-md lg:hidden mx-auto my-4 grid grid-cols-2 md:grid-cols-3 gap-4">
        <div className=" max-h-[500px] shadow-lg rounded-lg p-6 shadow-black/10 group relative">
          <div className="relative w-full md:h-[250px]">
            <img src={Friends} alt="Friends" className="w-full h-[80px] md:h-full" />
          </div>
          <h2 className="text-lg text-center font-bold py-2 md:hidden">Meetups and Interations</h2>
          <h2 className="text-lg text-center font-bold py-2 hidden md:block lg:hidden">Meetups/Interations</h2>
          <p className="">
        ...
        <div className=" max-h-[500px] shadow-lg rounded-lg p-6 shadow-black/10 relative">
          <div className="relative w-full md:h-[250px]">
            <img src={Game} alt="First Image" className="w-full h-[80px] md:h-full" />
          </div>
        ...
        <div className="max-h-[500px] shadow-lg rounded-lg p-6 shadow-black/10 group relative">
          <div className="relative w-full md:h-[250px]">
            <img src={Cosplay} alt="First Image" className="w-full h-[80px] md:h-full" />
          </div>
      ...
      <div className="hidden lg:block pt-10">
        <div className="w-full h-[40vh]">
          ...
          <h3 className="w-[30%] mx-auto text-center font-black text-2xl mt-4">Meetups/Interations</h3>
        ...
        <div className="w-full h-[30vh] my-auto px-16 flex justify-between">
          <div className="w-[30%] text-lg">
            <p className="w-full">
              <h3 className="font-black text-2xl">Games</h3>
              Play Console and Virtual Reality games from top Anime/Manga. Also
